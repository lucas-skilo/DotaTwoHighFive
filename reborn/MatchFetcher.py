...
def find_patch_for_match(match):
...
def validate_match(match, seq_num):
...
while True:
    ...
    for match in match_history['matches']:
        match_detailed = api.get_match_details(match['match_id'])
        validate_match(match_detailed, seq_num)
